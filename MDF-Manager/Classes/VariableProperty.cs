...
namespace MDF_Manager.Classes
{
    ...
    public class Float4 : INotifyPropertyChanged
    {
        ...
        public float x { get { return _X; } set { _X = value; UpdateColor(); OnPropertyChanged("x"); } }
        public float y { get { return _Y; } set { _Y = value; UpdateColor(); OnPropertyChanged("y"); } }
        public float z { get { return _Z; } set { _Z = value; UpdateColor(); OnPropertyChanged("z"); } }
        public float w { get { return _W; } set { _W = value; UpdateColor(); OnPropertyChanged("w"); } }
    ...
    public class Float4Property : IVariableProp, INotifyPropertyChanged
    {
        ...
        public object value { get { return _Default; } set { _Default = (Float4)value; OnPropertyChanged("value"); _Default.UpdateColor(); } }
        public int[] indexes { get; set; }
